...
from SwarmSwIM.sensors.visual_detection import CNNDetection
from SwarmSwIM.sensors.acoustic_comm import AcousticChannel
from SwarmSwIM.animator2D import Plotter
